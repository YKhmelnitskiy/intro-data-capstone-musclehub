...
ab_counts_categories = ['A','B']
plt.pie(ab_counts, labels = ab_counts_categories, autopct = '%0.2f%%')
plt.axis('equal')
plt.savefig('ab_test_pie_chart.png')
plt.show ('ab_test_pie_chart.png')
...
plt.show()
plt.savefig('Percent_Vistors_Apply.png')
...
plt.show()
plt.savefig('Percent_Applicants_Purchased_Membership.png')


# In[28]:


# Percent of all visitors who purchased a membership
ax = plt.subplot() 
...
ax.set_yticklabels(['0%','5%','10%','15%'])
plt.show()
plt.savefig('Percent_Visitors_Purchased_Membership.png')
